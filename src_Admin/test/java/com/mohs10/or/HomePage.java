	  ...
	  //By.xpath("//li[@class='inactive']//a[normalize-space()='Electronics']");
		 ...
		 // lnkJewelry =
		  ...
		  "//body[1]/div[4]/div[1]/div[4]/div[2]/div[2]/div[2]/div[3]/div[1]/div[1]/div[2]/div[3]/div[2]/input[1]"
				 ...
				 public static By
		  remove=By.xpath("//input[@name='removefromcart']"); public static By checkout
		  =By.xpath("//button[@id='checkout']"); public static By
		  adclick=By.xpath("//input[@id='termsofservice']");
